...
-- Existing fields are masked when their name looks like a secret: the UI's
-- old rule (pass|pin|secret|token|key) plus "pwd", a common short name for a
-- password that the old rule missed.
