...
interface Props {
  ...
  onEdit: (theatre: QubeAcsTheatre) => void;
}
...
export const QubeAcsDetailSheet = ({ theatre, open, onOpenChange, onEdit }: Props) => {
          ...
          <div className="p-5 space-y-6">
            ...
            <section className="space-y-3">
              ...
              {activeScreens.length === 0 ? (
                <p className="text-sm text-muted-foreground italic">No active Qube ACS devices.</p>
              ) : (
