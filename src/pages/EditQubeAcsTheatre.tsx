...
const EditQubeAcsTheatre = () => {
  ...
  const updateScreen = (sid: string, patch: Partial<QubeAcsScreenDevice>) =>
    ...
    <div className="space-y-5 animate-fade-in">
      <div className="flex items-center justify-between gap-3">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h2 className="text-lg font-semibold">Edit Qube ACS Theatre</h2>
              ...
              <div className="space-y-6">
                ...
                <section className="space-y-3">
                  ...
                  {!active.hasDevice && !editDevice ? (
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div className="space-y-1"><Label className="text-xs">Qube ACS Appliance ID</Label><Input value={active.applianceId ?? ""} onChange={(e) => updateScreen(active.screenId, { applianceId: e.target.value })} /></div>
...
export default EditQubeAcsTheatre;
