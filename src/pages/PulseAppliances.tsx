...
import type { PulseTheatre } from "@/data/pulseData";
...
const PulseAppliances = () => {
  ...
  const theatresQuery = useApplianceTheatres("pulse");
  const data = useMemo<PulseTheatre[]>(() => theatresQuery.data ?? [], [theatresQuery.data]);
